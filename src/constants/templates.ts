...
<span class="code-tabs--icon_group"
        style="position:absolute; top:2em; right:6px; padding:0;">
    <span class="code-tabs--icon_refresh" 
        onclick="pluginCodeTabs.refreshEcharts(event)" 
            title="刷新图表">
        <svg width="14" height="14" style="display:block">
            <use xlink:href="/plugins/code-tabs/asset/code-tabs-icons.svg#iconRefresh"></use>
        </svg>
    </span>
</span>`
    .replace(/>\s+</g, "><")
...
export const settingIconMain = `<svg viewBox="0 0 500 500">
